    ...
    <div className="min-h-screen bg-background">
      <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="max-w-7xl mx-auto px-6 flex h-16 items-center justify-between gap-4">
          <a 
            href="/" 
            className="flex items-center gap-2 hover-elevate active-elevate-2 rounded-lg px-3 py-2 -ml-3 transition-colors" 
          ...
          <nav className="flex items-center gap-2">
            <a href="/" data-testid="link-generator">
              <Button
            ...
            <a href="/history" data-testid="link-history">
              <Button
